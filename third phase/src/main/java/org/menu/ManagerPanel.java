...
public class ManagerPanel extends Menu {
    ...
    public void getCommandList() {
        ...
        manageCategories.setOnAction(event -> {
        ...
        manageRequests.setOnAction(event -> {

                App.getMainStage().setScene(manageRequests());

        });

        Button manageSells=new Button("manage sells");
        manageSells.setPrefSize(200,50);
        manageSells.getStyleClass().add("command");
        manageSells.setOnAction(actionEvent -> {

                App.getMainStage().setScene(manageSells());

        });

        commands.getChildren().addAll(profile, edit, manageUsers, manageCategories, manageProducts,
                createDiscount, viewDiscounts, manageRequests,manageSells);
    ...
    public Menu manageProducts()  {
        return new Menu(new ScrollPane()) {
            ...
            public void init() {
                ...
                productTable.setItems(FXCollections.observableArrayList(Product.getAllProducts()));

                TableColumn<Product,ImageView> image=new TableColumn<>("picture");
                image.setCellValueFactory(new PropertyValueFactory<>("picture"));

                TableColumn<Product,String> name=new TableColumn<>("name");
                name.setCellValueFactory(new PropertyValueFactory<>("name"));

                TableColumn<Product,Float> price=new TableColumn<>("price");
                price.setCellValueFactory(new PropertyValueFactory<>("price"));

                productTable.getColumns().addAll(image,name,price);
                ...
                pane.getChildren().add(new VBox(productTable,delete));
            }
        };
    }
    ...
    public void getInfoGrid() {
        ...
        info.add(new Text("manager: "+user.getUsername()),0,0);
    ...
    public Menu manageUsers()  {
        return new Menu(new ScrollPane()) {
            ...
            public void init() {
                ...
                TableColumn<User,Boolean> logColumn=new TableColumn<>("logged in");
                logColumn.setCellValueFactory(new PropertyValueFactory<>("loggedIn"));

                ObservableList<User> users = FXCollections.observableArrayList();
                users.addAll(User.getUsers());
                userList.setItems(users);
                userList.getColumns().addAll(name, fNameColumn,lNameColumn,emailColumn,role,logColumn);
                ...
                createManager.setOnAction(event -> {

                        App.getMainStage().setScene(createManager());

                });

                Button createSupporter=new Button("create supporter");
                createSupporter.setOnAction(event ->{

                        App.getMainStage().setScene(createSupporter());

                });

                list.getChildren().addAll(cancel,delete,createManager,createSupporter,userList);
        ...
        return new Menu(new ScrollPane()) {
            ...
            public void init() {
                ...
                submit.setOnAction(event -> {
                    ...
                    try {
                        App.getDataOutputStream().writeUTF("submitManager "+usernameField.getText()+", "+fNameField.getText()+", "+lNameField.getText()+", "+
                                emailField.getText()+", "+phoneField.getText()+", "+passwordField.getText()+", "+file.toURI().toString());
                        App.getDataOutputStream().flush();
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
        ...
        return new Menu(new ScrollPane()) {
            ...
            public void init() {
                ...
                submit.setOnAction(event -> {
                    ...
                    try {
                        App.getDataOutputStream().writeUTF("submitSupporter "+usernameField.getText()+"' "+fNameField.getText()+"' "+lNameField.getText()+", "+
                                emailField.getText()+", "+phoneField.getText()+", "+passwordField.getText()+", "+file.toURI().toString());
                        App.getDataOutputStream().flush();
                    } catch (IOException e) {
                        e.printStackTrace();
        ...
        return new Menu(new ScrollPane()) {
            ...
            public void init() {
                ...
                add.setOnAction(event -> {
                        ...
                        App.getMainStage().setScene(getNewCategory());
            ...
            public void init() {
                ...
                ok.setOnAction(event -> {
                    ...
                    if (percentField.getText().isEmpty()) {
                        ...
                        new Alert(Alert.AlertType.INFORMATION, "discount successfully added").show();
        ...
        return new Menu(new ScrollPane()) {
            ...
            public void init() {
                ...
                delete.setOnAction(event -> {
                        ...
                        deleteDiscount(discounts.getSelectionModel().getSelectedItem());
                ...
                edit.setOnAction(event -> {
                        ...
                        App.getMainStage().setScene(editDiscount(discounts.getSelectionModel().getSelectedItem()));
    ...
    public Menu specificOrder(BuyLog order) {
        return new Menu(new ScrollPane()) {
            ...
            public void init() {
                ...
                ChoiceBox<String> orderState=new ChoiceBox<>();
                orderState.getItems().addAll("preparing the order","delivered to post station","arrived to destination");

                Button changeState=new Button("change state");
                changeState.setOnAction(actionEvent -> {
                    order.changeState(orderState.getSelectionModel().getSelectedItem());
                });

                content.getChildren().add(new HBox(orderState,changeState));
