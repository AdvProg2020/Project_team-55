...
public class SellerPageController {
    ...
    Scanner scanner;
    String command;
    JustUniqueProduct uniqueProduct;
    ...
    public void showProductBuyers(String id) {
        ...
        while (!(command = scanner.nextLine().trim().toLowerCase()).equalsIgnoreCase("back")) {
            if (Category.categoryWithNameExists(command)) {
                if (Category.getCategoryByName(command).equals(product.getCategory())) {
                    ...
                    new ProductEditRequest(product, seller).changeCategory(Category.getCategoryByName(command));
    ...
    public ArrayList<Product> enterOffProducts() {
        ...
        while (!(command = scanner.nextLine().trim()).equalsIgnoreCase("end")) {
            ...
            if (Product.productWithIdExists(command)) {
