...
public class LoginRegister {
    ...
    private void registerBuyer(String command) {
        ...
        controller.login(new Buyer(username, firsName, lastName, email, number, password, Float.parseFloat(credit)));
    }//buyer
    ...
    private void registerSeller(String command) {
        ...
        if ((credit = controller.enterInitialCredit()).equalsIgnoreCase("back")) return;
        System.out.println("you registered successfully");
        controller.login(new Seller(factory, username, firsName, lastName, email, number, password, Float.parseFloat(credit)));
    }
    ...
    private void registerManager(String command) {
        if (Manager.getMainManager() == null) {
            ...
            if ((number = controller.enterPhoneNumber()).equalsIgnoreCase("back")) return;
            System.out.println("you registered successfully");
            controller.login(new Manager(username, firsName, lastName, email, number, password));
        } else {
    ...
    public static LoginRegister getInstance() {
        if (loginRegister == null) return loginRegister=new LoginRegister();
