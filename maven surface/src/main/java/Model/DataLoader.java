...
public class DataLoader {
    ...
    private void readUsers() throws IOException {
        BufferedReader buyerReader=new BufferedReader(new FileReader("./database/buyers.json"));
        BufferedReader sellerReader=new BufferedReader(new FileReader("./database/sellers.json"));
        BufferedReader managerReader=new BufferedReader(new FileReader("./database/managers.json"));
        BufferedReader mainManager=new BufferedReader(new FileReader("./database/mainManager.json"));
    ...
    private void readProducts() throws IOException{
        BufferedReader productReader=new BufferedReader(new FileReader("./database/products.json"));
        Product product;
    ...
    private void readCategories() throws IOException{
        BufferedReader categoryReader=new BufferedReader(new FileReader("./database/categories.json"));
        Category category;
    ...
    private void readOffs() throws IOException{
        BufferedReader offReader=new BufferedReader(new FileReader("./database/offs.json"));
        Off off;
    ...
    private void readDiscounts() throws IOException{
        BufferedReader discountReader= new BufferedReader(new FileReader("./database/discounts.json"));
    ...
    private void readRequests() throws IOException{
        BufferedReader productAddReader=new BufferedReader(new FileReader("./database/productAdditionRequests.json"));
        ...
        BufferedReader productEditReader=new BufferedReader(new FileReader("./database/productEditRequests.json"));
        ...
        BufferedReader productRemovalReader=new BufferedReader(new FileReader("./database/productRemovalRequests.json"));
        ...
        BufferedReader offAddReader=new BufferedReader(new FileReader("./database/offAdditionRequests.json"));
        ...
        offAddReader.close();
        BufferedReader offEditReader=new BufferedReader(new FileReader("./database/offEditRequests.json"));
    ...
    private void readLogs() throws IOException{
        BufferedReader sellReader=new BufferedReader(new FileReader("./database/sellLog.json"));
        SellLog sellLog;
        while ((sellLog=gson.fromJson(sellReader,SellLog.class))!=null){
            SellLog.getAllSales().add(sellLog);
        }
        sellReader.close();
        BufferedReader buyReader=new BufferedReader(new FileReader("./database/buyLog.json"));
        BuyLog buyLog;
    ...
    private void readScore() throws IOException{
        BufferedReader score=new BufferedReader(new FileReader("./database/scores.json"));
