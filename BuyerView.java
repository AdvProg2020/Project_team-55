        ...
        if (inputForBuyer.trim().equals("view personal info") || inputForBuyer.endsWith("info")) {
            ...
            for (User searching : User.users) {
                ...
                if (inputForBuyer.startsWith("edit")) {
                    ...
                    if (parts.equals("firstname") || parts.equals("Firstname") || parts.equals("first name") || parts.equals("First name")) {
                        searching.setFirstName(scannerForBuyerView.nextLine());
                    }

                    if (parts.equals("lastname") || parts.equals("Lastname") || parts.equals("last name") || parts.equals("Last name")) {
                        searching.setLastName(scannerForBuyerView.nextLine());
                    }


                    if (parts.equals("password") || parts.equals("Password") || parts.equals("pass word") || parts.equals("Pass word")) {
                    ...
                    if (parts.equals("Number") || parts.equals("number") || parts.equals("phonenumber") || parts.equals("phone number")
                            || parts.equals("Phone number") || parts.equals("Phonenumber") || parts.equals("telephonenumber")
                            || parts.equals("telephone number") || parts.equals("Telephonenumber") || parts.equals("Telephone number")) {
                    ...
                    if (parts.equals("Email") || parts.equals("email") || parts.equals("mail") || parts.equals("Mail")) {
